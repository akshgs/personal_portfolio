...
const ARTICLES = [
  {
    ...
    excerpt:
      "How I transitioned from a BBA background into Data Science, learning Python, Machine Learning, and building real-world AI projects.",
    category: "Journey",
    readTime: "5 min read",
  ...
  {
    title: "Building an Air Drawing System with OpenCV",
    excerpt:
      "A computer vision project that allows users to draw in the air using hand gestures with Python, OpenCV, and MediaPipe.",
  ...
  {
    title: "Detecting Fraud in Ethereum Transactions",
    excerpt:
      "Using Machine Learning models to detect fraudulent blockchain transactions through feature engineering and model evaluation.",
